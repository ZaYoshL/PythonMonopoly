...
# Import the function Monopoly Map from MonopolyMap.py
from MonopolyMap import MonopolyMap
from Player import Player, createPlayers
#import randint
...
while True:
    if playerTurn == 5:
        ...
        MonopolyMap(Player1Location, Player2Location, Player3Location, Player4Location,
